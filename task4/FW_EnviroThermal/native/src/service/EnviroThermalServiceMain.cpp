...
#undef LOG_TAG
#endif
#define LOG_TAG "EnviroThermal-service"

namespace esnamespace = enviro_thermal_service::service;
...
int main()
{
   ...
   {
      std::shared_ptr<esnamespace::EnviroThermalService> esObj = esnamespace::EnviroThermalService::getInstance();
      if (esObj)
      {
