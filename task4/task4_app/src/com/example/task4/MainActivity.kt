...
class MainActivity : AppCompatActivity() {
  ...
  private lateinit var serviceInterface: IExampleService
  ...
  override fun onCreate(savedInstanceState: Bundle?) 
  {
    ...
    val binder = getServiceMethod.invoke(null, "example.service.api.IExampleService/default") as IBinder
    serviceInterface = IExampleService.Stub.asInterface(binder)
