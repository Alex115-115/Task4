...
#undef LOG_TAG
#endif
#define LOG_TAG "TemperatureDevice-service"

namespace esnamespace = android::hardware;
...
int main()
{
   ...
   {
      std::shared_ptr<esnamespace::TemperatureDevice> esObj = esnamespace::TemperatureDevice::getInstance();
      if (esObj)
      {
